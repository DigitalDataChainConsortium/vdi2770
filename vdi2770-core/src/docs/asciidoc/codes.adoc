...
OI_003:: The value of this element is not a valid URL.
OI_004:: Uppercase letters are only allowed in the Path, Query or Fragment components of the URL. See DIN SPEC 91406 or IEC 61406 for more information.
OI_005:: The URL should not be extended beyond a length of 100 characters.
OI_006:: The URL shall not be longer than 255 characters.
OI_007:: The URL may contain punycode.This should be avoided..
OI_008:: The URL contains invalid characters.
